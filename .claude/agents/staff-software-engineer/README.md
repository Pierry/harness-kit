...
- `/sse:firebase-publish`: create or reuse a Firebase project, configure Hosting, deploy the current static site. Never deletes. Post-pipeline deploy step for static web work.
